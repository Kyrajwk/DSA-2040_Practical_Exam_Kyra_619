...
- **Visuals:** `iris_pairplot.png`, `iris_corr_heatmap.png`, `iris_boxplots.png`
...
- **Saves:** `clustering_scores.csv`, `kmeans_elbow.png`, `kmeans_clusters_k3.png`, `clustering_analysis.md`
...
### Section 2
1. Run `mining/preprocessing_iris.ipynb` → saves scaled data & EDA plots.
2. Run `mining/clustering_iris.ipynb` → K-Means, ARI, elbow, scatter.
3. Run `mining/mining_iris_basket.ipynb` → DT vs KNN + Apriori rules.
